...
client.login('NTA0NjY2ODc5NDQ1Njk2NTEy.D1KC0Q.OORKTMVbX6U0TjUkJq6LMjBNRHY')
...
client.on("guildMemberAdd", member => {
    ...
    return channel.send(`:rose:  ولكم نورت السيرفر الاساطير:rose: 
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**_ping :stopwatch:**","**لـ سرعة إتصالك**")
      .addField("**_id :chart_with_downwards_trend:**","**عرض سرعه اتصال البوت**")
      .addField("**_avatar :camping:**","**لـ صور الشخص المختار**")
      .addField("**_roll :1234:**","**لـ القرعه من 1 - 100**")
      .addField("**_server :recycle:**","**لـ معلومات السيرفر**")
...
client.on('message', message => {
    ...
    if (message.content.indexOf('_Reverse') === 0) {
        var textadam = message.content.substring(1);
        var reversedadam = '';
        var i = textadam.length;
        while (i > 0) {
            reversedadam += textadam.substring(i - 1, i);
            i--;
        }
 message.channel.send(reversedadam);
    }
});
